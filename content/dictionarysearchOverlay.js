...
init: function () {
    ...
    if (!this.prefs.prefHasUserValue("menutext1")){
    ...
    for (i = 2; i <= this.NUM_DICTIONARIES; i++) {
    ...
    if (!this.prefs.prefHasUserValue("version") || this.prefs.getCharPref("version") != this.VERSION) {
		this.debug("init(): no version found or newer version");
		url = "http://dictionarysearch.mozdev.org/thanks.html";
